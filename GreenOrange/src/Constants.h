...
constexpr int DEFAULT_CUBE_MAP_SIZE = 64;
...
constexpr const char *REPLACE_CAMERAS_INIT = "#GO_REPLACE_CAMERAS_INIT";
constexpr const char *REPLACE_CAMERA_COUNT = "#GO_REPLACE_CAMERA_COUNT";
constexpr const char *REPLACE_CAMERA_CURRENT = "#GO_REPLACE_CAMERA_CURRENT";
